...
function ler( res ){
    ...
    conexao.query( sql, (erro, resultados) => {
        ...
        if(resultados.length === 0){
            // Indicamos o status de sem conteúdo e encerra
            res.status(204).end();
            return;
        }
...
function atualizar(id, aluno, res){
    ...
    eles devem ser colocados em ordem e dentro de um array */0
    conexao.query(sql, [aluno, id], (erro, resultados) => {
        ...
        if(erro) {
            ...
            os dados do objeto aluno dentro do objeto json junto com o id*/
